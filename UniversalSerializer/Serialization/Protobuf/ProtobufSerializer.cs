...
public class ProtobufSerializer : SerializerBase
{
		...
		: base(options)
	{
		...
		_typeModel = ProtoBuf.Meta.RuntimeTypeModel.Create();
	...
	public override T? DeserializeFromStream<T>(Stream stream)
	{
		...
		try
		{
			return (T?)(T?)_typeModel.Deserialize(stream, null, typeof(T));
		}
		catch (Exception ex)
		{
	...
	private void ConfigureTypeModel()
	{
		...
		var skipConstructor = Options.GetOption(SerializerOptionKeys.Protobuf.SkipConstructor, false);
		var omitAssemblyVersion = Options.GetOption(SerializerOptionKeys.Protobuf.OmitAssemblyVersion, true);
		var allowPrivateMembers = Options.GetOption(SerializerOptionKeys.Protobuf.AllowPrivateMembers, false);
		var useCompatibilityMode = Options.GetOption(SerializerOptionKeys.Protobuf.UseCompatibilityMode, false);
